...
func DialNumber(company, tenant int, resourceServer ResourceServerInfo, campaignId, uuid, fromNumber, trunkCode, phoneNumber, tryCount, extention string) {
	...
	InitiateSessionInfo(company, tenant, 240, "Campaign", "Dialer", "BlastDial", tryCount, campaignId, uuid, phoneNumber, "start", "start", time.Now().UTC().Format(layout4), resourceServer.ResourceServerId)
