...
func SendSmsDirect(company, tenant int, message, phoneNumber string) {
	...
	InitiateSessionInfo(company, tenant, 240, "SMS", "DIRECT", "DIALOUT", "1", campaignId, campaignId, dnis, dnis, "start", "dial_start", time.Now().UTC().Format(layout4), serverInfo.ResourceServerId)
